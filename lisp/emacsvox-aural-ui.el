...
(defconst emacsvox-aural-ui-manual-nodes
  '((emacsvox-aural-home-mode . "Aural Home")
    ...
    (emacsvox-aural-voice-editor-mode . "Editing Named Voices")
    (emacsvox-aural-voice-bulk-mode . "Editing Named Voices")
    (emacsvox-aural-voice-context-mode . "Voices In Context")
    ...
    (emacsvox-aural-scheme-editor-mode . "Managing Feedback Rules")
    (emacsvox-aural-overrides-mode . "Managing Feedback Rules")
    (emacsvox-aural-change-feedback-mode . "Guided Feedback Changes")
    (emacsvox-aural-feature-fragments-mode . "Presentation Options")
    (emacsvox-aural-feature-fragment-previews-mode . "Presentation Options"))
