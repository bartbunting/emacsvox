...
(defconst emacsvox-python-aural-fragment
  '(:schema-version 1
  ...
  "Always-on semantic presentation rules supplied by Python mode.")

(unless
    (gethash
     'python-interaction-feedback
     emacsvox-aural-module-fragment-registry)
  (emacsvox-aural-register-module-fragment
   'python emacsvox-python-aural-fragment :source "emacsvox-python"))
