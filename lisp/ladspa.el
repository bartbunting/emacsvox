...
;; $Author: tv.raman.tv $
;; Description:  Expose Ladspa Plugins to Emacs/Emacsvox
;; Keywords: Emacsvox,  Audio Desktop Ladspa
;;;   LCD Archive entry:
...
(define-derived-mode ladspa-mode special-mode
  ...
  "A Ladspa workbench for the Emacsvox desktop."
  (setq tab-width 8
        tab-stop-list '(16))
...
(declare-function emacsvox-m-player-add-ladspa "emacsvox-m-player.el")
(declare-function emacsvox-m-player-delete-ladspa "emacsvox-m-player.el")

(cl-declaim (special ladspa-mode-map))
(cl-loop for k in
         '(
           ("RET" ladspa-instantiate)
           ("a" emacsvox-m-player-add-ladspa)
           ("d" emacsvox-m-player-delete-ladspa)
           ("p" previous-line)
           ("n" next-line)
