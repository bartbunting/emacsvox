  ...
  (emacsvox-aural-ui-with-help-window
    (princ
     (concat
      ...
      "A profile selects ordered presentation options, a sound pack, a voice\n"
      "palette, and spatial settings. It references their shared definitions;\n"
      "it does not copy them. Rules, engine settings, speech rate, notification\n"
      "output, and buffer-local Voice Lock are managed separately.\n"
      "One profile identity can be selected.\n"
      ...
      "live differences. Manage rules through Presentation options and\n"
      "Your feedback rules in Home.\n\n"
