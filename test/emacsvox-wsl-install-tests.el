...
(defun emacsvox-wsl-install-tests--write-manifest (root omnivox-sha256)
  ...
  (with-temp-file (expand-file-name "etc/wsl-install.conf" root)
    (insert
     ...
     "EMACSVOX_WSL_OMNIVOX_VERSION=1.7.0\n"
     "EMACSVOX_WSL_OMNIVOX_RELEASE_URL=https://example.invalid/v1.7.0\n"
     "EMACSVOX_WSL_OMNIVOX_WINDOWS_X64_ARCHIVE=omnivox-1.7.0-windows-x64.zip\n"
     "EMACSVOX_WSL_OMNIVOX_WINDOWS_X64_SHA256=" omnivox-sha256 "\n"
     "EMACSVOX_WSL_OMNIVOX_WINDOWS_ARM64_ARCHIVE=omnivox-1.7.0-windows-arm64.zip\n"
    ...
    (unwind-protect
        (progn
          ...
          (let* ((environment
            ...
            (should
             (string-search
              "Omnivox 1.7.0 is already installed and selected" output))
