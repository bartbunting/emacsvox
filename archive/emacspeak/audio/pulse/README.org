...
** Sinks For Emacsvox Notifications

Emacsvox sends speech notifications to the right ear by default.
...
** Speaker Vs Headphone 
  ...
  1.   Unplugging headphones  initially left  speaker muted and
     ...
     in Emacsvox if necessary. See asound.state here for my
     sound-card; I place it in _~/.emacs.d~ for Emacsvox to find
...
** Outloud TTS And Latency 
  ...
  2. To work around this issue, recompile the Emacsvox linux-outloud
