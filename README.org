...
3. Start the isolated first session:
   ...
   ./bin/emacsvox
   #+END_SRC
   Once Omnivox negotiation completes, success includes the stable spoken
   checkpoint, ``Emacsvox is ready.''  An earlier introduction and an auditory
   icon may also be heard, but neither is the acceptance checkpoint.  Type
