...
(defun emacsvox-aural-audit--insert-overview ()
  ...
  (insert
   ...
   "editable personal copy before tuning.  While the tuner is active, its "
   "navigation, cells, rows, boundaries, and help use the current unsaved "
   "working voice.  In the tuner, =P= speaks the longer sample and =B= "
   "alternates opening-style and working-style comparison samples.  For "
   "routed adapters, the tuner's "
