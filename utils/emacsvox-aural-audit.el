...
(defun emacsvox-aural-audit--insert-overview ()
  ...
  (insert
   ...
   "Use =M-x emacsvox-edit-aural-scheme= for a persistent personal scheme, "
   "or =M-x emacsvox-edit-aural-rules= for persistent, session, or "
   "buffer-local rules.  =M-x emacsvox-explain-aural-presentation= shows "
   "facts, context, matching rules, provenance, concrete resources, "
   "suppression, and backend degradation at point.\n\n"
