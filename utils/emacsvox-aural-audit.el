...
(defun emacsvox-aural-audit--insert-overview ()
  ...
  (insert
   ...
   "machine's installed inventory.  =P= previews the current row without "
   "saving, =a= assigns a physical voice, and =u= or =x= undo one edit or "
   "cancel the complete staged copy.  In the engine view, =O= and =[/]= "
   ...
   "These global lists are stored in the versioned machine routing profile "
   "and are not duplicated into the portable palette or each logical voice."
   "\n\n"
