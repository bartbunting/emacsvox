...
(defun emacsvox-aural-audit--insert-overview ()
  ...
  (insert
   ...
   "It reports current status and routes to explanation, schemes, feature "
   "fragments, presentation profiles, source-buffer rules, semantic "
   ...
   "state.  It does not start the server or repair anything automatically.  "
   ...
   "feature fragments, persistent user rules, session rules, and buffer "
   "rules.  One base scheme is active, while any number of independent "
   "feature fragments may add presentation without replacing it.  Within an origin, semantic "
...
(defun emacsvox-aural-audit--insert-scheme-author-reference ()
  ...
  (insert
   ...
   "=:enabled-feature-fragments=, =:profiles=, and =:user-rules= fields.\n\n"
...
(defun emacsvox-aural-audit--insert-migration ()
  ...
  (insert
   ...
   "such a rule, normal Voice Lock behavior remains authoritative.  A "
