...
(defun emacsvox-aural-audit--insert-overview ()
  ...
  (insert
   ...
   "fragments, source-buffer rules, semantic vocabulary, sound packs, spatial "
   "controls, training, and diagnostics.  Press =h= in any routed manager or "
   "editor to return home.  From an ordinary buffer, =C-e E= always invokes "
