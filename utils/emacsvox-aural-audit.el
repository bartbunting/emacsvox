...
(defun emacsvox-aural-audit--insert-overview ()
  ...
  (insert
   ...
   "and =t= opens the route-aware tuner; none saves configuration.  If the "
   "active voice palette is built in, =t= offers to create and activate an "
   "editable personal copy before tuning.  =a= "
   "assigns a physical voice, =j= reviews an alias, language, gender, or "
   "engine-default suggestion, and =u= or =x= undo one edit or cancel the "
   "complete staged copy.  =m= stages legacy Omnivox or active "
   ...
   "is persisted automatically.  In the engine view, =O= and =[/]= "
   ...
   "Use =w= to atomically save and apply every live speech stream, =r= to "
   "retry a partial apply, and =U= to restore the prior saved revision.  "
