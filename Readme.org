...
This is currently a configuration and diagnostics foundation.  The legacy
speech queue still supplies the spoken voice; per-span engine routing will make
the registered engine-and-voice assignments control synthesis in the next
Omnivox phase.
