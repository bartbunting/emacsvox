...
=M-x emacsvox-sounds-select-theme= or choose it as a scheme's sound pack.
Partial packs can inherit from another pack through a data-only
=emacsvox-sound-pack.el= manifest; the generated reference documents its
validated fields.
