...
fragments, buffer-local rules, semantic vocabulary, sound packs, spatial
controls, training, and the Aural Doctor.  From an ordinary buffer, =C-e E=
always runs
...
six modules as migrated and rejects a new context-free direct icon call.
