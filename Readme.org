...
This builds the Piper-enabled Windows executable, separate 32-bit Eloquence
and DECtalk capture helpers, a native copy of the platform-neutral eSpeak
voice data, and the checksum-pinned official Piper companion, then stages them
