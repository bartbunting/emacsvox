...
5. Install and test Omnivox:
   ...
   platform.  Run its standalone check and continue only after hearing both
   the test tone and speech.  Direct eSpeak, SwiftMac, macOS Python,
   Eloquence, and DECtalk servers are compatibility alternatives, not the
   initial-user path.

6. Set Up the TTS Engine:
   After installing Omnivox, add this to the shell startup file used to launch
   Emacs:
   #+BEGIN_SRC sh
