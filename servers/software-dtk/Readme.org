...
This module implements  the Emacsvox speech server for software
Dectalk.
...
1. In a shell, run ./servers/dtk-soft from the emacsvox directory.
2. If it works, then ask Emacsvox to use it as you would with any
   other speech server.
